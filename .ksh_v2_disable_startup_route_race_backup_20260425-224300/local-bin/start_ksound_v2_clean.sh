...
echo
echo "===== RESTORE APP ROUTES ====="
"$HOME/.local/bin/ksound-v2-restore-routes" >/tmp/ksound-hub-v2-route-restore.log 2>&1 || true
tail -n 30 /tmp/ksound-hub-v2-route-restore.log 2>/dev/null || true

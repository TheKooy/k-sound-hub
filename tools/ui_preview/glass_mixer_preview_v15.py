...
class PadsPanel(QWidget):
    ...
    def __init__(self, detach_callback=None, columns: int = 2, show_detach: bool = True):
        ...
        self.cancel_bulk = QPushButton("Cancel")
        self.cancel_bulk.setObjectName("padCancelButton")
        self.cancel_bulk.clicked.connect(self._stop_bulk_delete)
        self.cancel_bulk.setVisible(False)
        top_layout.addWidget(self.cancel_bulk)
    ...
    def _start_bulk_delete(self) -> None:
        ...
        self.bulk_delete.setChecked(True)
        self.cancel_bulk.setVisible(True)
        self.emoji_overlay.hide()

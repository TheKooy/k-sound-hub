...
class AdaptiveScrollArea(QScrollArea):
    def __init__(self):
        ...
        self.verticalScrollBar().rangeChanged.connect(self._update_scroll_margin)

    def _update_scroll_margin(self, minimum: int = 0, maximum: int = 0) -> None:
        has_scroll = self.verticalScrollBar().maximum() > 0
        self.setViewportMargins(0, 0, 6 if has_scroll else 0, 0)

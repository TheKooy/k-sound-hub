...
class ChannelCard(QFrame):
    def __init__(self, name: str, icon: str, devices: list[str], value: int):
        ...
        device_combo.lineEdit().setReadOnly(True)
        device_combo.lineEdit().setAlignment(Qt.AlignCenter)
        device_combo.lineEdit().setFrame(False)
...
class SoundPadCard(QFrame):
    def __init__(self, name: str, icon: str, meta: str):
        ...
        icon_label = QLabel(icon)
        icon_label.setObjectName("soundPadIcon")
        icon_label.setAlignment(Qt.AlignCenter)
        root.addWidget(icon_label, 0, Qt.AlignHCenter)

        name_label = QLabel(name)
        name_label.setObjectName("soundPadName")
        name_label.setAlignment(Qt.AlignCenter)
    ...
    def set_edit_mode(self, enabled: bool) -> None:
        ...
        self.setMinimumHeight(102 if enabled else 72)
        self.style().unpolish(self)
        self.style().polish(self)
        self.update()

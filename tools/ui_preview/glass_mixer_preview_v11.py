...
class SoundPadCard(QFrame):
    ...
    def set_edit_mode(self, enabled: bool) -> None:
        ...
        self.setMinimumHeight(118 if enabled else 86)
        self.style().unpolish(self)
        self.style().polish(self)
        self.update()
...
class DetachedPadsWindow(QMainWindow):
    def __init__(self):
        ...
        panel = PadsPanel(detach_callback=None, columns=3)
...
class Drawer(QFrame):
    ...
    def _pads_page(self) -> QWidget:
        ...
        self.pads_panel = PadsPanel(detach_callback=self._detach_pads, columns=2)
